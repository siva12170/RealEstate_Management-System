	    		...
	    		<div class="row">
	    			...
	    			<div class="col-sm-4">
	    				...
	    				<form action="ValidateAgentLogin.jsp" method="post">
							<h3 style="color: rgb(246, 204, 185);font-size:1.9em;"><b>AgentId:</b></h3> <input autocomplete="off" class="form-control" type="text" name="agentId" placeholder="Enter Your AgentId" required="">
							<br><br>
							<h3 style="color: rgb(246, 204, 185);font-size:1.9em;"><b>Password:</b></h3><input autocomplete="off" class="form-control" type="password" name="agentPassword" placeholder ="Enter Your Password" required="">
							<br><br>	
