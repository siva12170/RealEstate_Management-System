	    		...
	    		<div class="row">
	    			...
	    			<div class="col-sm-4">
	    				...
	    				<form action="ValidateSellerRegister.jsp" method="get">
							<h3 style="color:navy;font-size:1.9em;"><b>Seller Name:</b></h3> <input autocomplete="off" class="form-control" type="text" name="sellerName" placeholder="Your name.." required="">
							<br><br>
							<h3 style="color:navy;font-size:1.9em;"><b>Seller Contact Number:</b></h3> <input autocomplete="off" class="form-control" type="text" name="sellerContact" pattern="[0-9]{10}" placeholder="10 digit phone number.." required="">
							<br><br>

							<h3 style="color:navy;font-size:1.9em;"><b>Password:</b></h3> <input autocomplete="off" class="form-control" type="password" name="sellerPassword" pattern=".{8,}"  placeholder="Eight or More characters password.." required="">
							<br><br>
