	    		...
	    		<div class="row">
	    			...
	    			<div class="col-sm-4">
	    				...
	    				<form action="ValidateEmployeeLogin.jsp" method="post">
							EmployeeId  : <input autocomplete="off" class="form-control" type="text" name="employeeId" required="">
							<br><br>

							Password  : <input autocomplete="off" class="form-control" type="password" name="buyerPassword" required="">
							<br><br>
