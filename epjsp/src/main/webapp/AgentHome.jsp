	  ...
	  <a class="navbar-brand" href="index.jsp"><i class="glyphicon glyphicon-home"></i>  Real-Estate</a>
		...
		<div class="container">
	    	...
	    	<div class="d-flex justify-content-center align-items-center ">
	    		...
	    		<div class="row">
					 <div class="col-sm-4">
						<button type="button" onclick="location.href='UpdateHouseStatus.jsp'" class="btn btn-primary btn-lg btn-block">UPDATE HOUSE STATUS</button>

						<br> <br>

						<button type="button" onclick="location.href='UpdateLeavingStatus.jsp'" class="btn btn-primary btn-lg btn-block">UPDATE LEAVING DETAILS(RENT) </button>

						<br> <br>

						<button type="button" onclick="location.href='ViewAgentHouses.jsp'" class="btn btn-primary btn-lg btn-block">VIEW HOUSES ASSOCIATED</button>
